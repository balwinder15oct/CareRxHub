...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
    <?php
        ...
        $medicine_shop_post_id = get_the_ID(); // Add this line to get the post ID
        $medicine_shop_gallery_shortcode = get_post_gallery();

        if (!empty($medicine_shop_gallery_shortcode)) {
            // Display the gallery
            echo '<div class="embedded-gallery">' . do_shortcode($medicine_shop_gallery_shortcode) . '</div>';
        }
    ?>
