...
<body <?php body_class();?> >
	<?php wp_body_open(); ?>
	<?php $medicine_shop_preloader = get_theme_mod('medicine_shop_preloader_setting', '0');
	  if($medicine_shop_preloader == '1') { ?>
		<div class="loading">
			<div class="loader">
			<?php $medicine_shop_preloader_text = get_theme_mod('medicine_shop_preloader_text','Loading');
				if (!empty($medicine_shop_preloader_text)) { ?> <?php echo esc_html($medicine_shop_preloader_text); ?> <?php } ?>
			  <span></span>
			</div>
		</div>
	<?php } ?>
