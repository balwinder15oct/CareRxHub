...
jQuery(document).ready(function(){
    ...
    jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-menu').attr("checked","checked");

    jQuery('#medicine-shop-setup-menu').click(function(){
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-menu').css("display","block");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-contact').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-widget').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-social-icon').css("display","none");
    });

    jQuery('#medicine-shop-setup-contact').click(function(){
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-menu').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-contact').css("display","block");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-widget').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-social-icon').css("display","none");
    });

    jQuery('#medicine-shop-setup-widget').click(function(){
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-menu').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-contact').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-widget').css("display","block");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-social-icon').css("display","none");
    });

    jQuery('#medicine-shop-setup-social').click(function(){
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-menu').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-contact').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-widget').css("display","none");
        jQuery('#medicine-shop-demo-setup-guid .medicine-shop-setup-social-icon').css("display","block");
    });
});