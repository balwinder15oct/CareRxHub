...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
                $medicine_shop_search_result_sidebar_setting = get_theme_mod('medicine_shop_search_result_sidebar_setting','1');
                $medicine_shop_sidebar_position = get_theme_mod('medicine_shop_sidebar_position', 'right');
                $medicine_shop_content_class = ($medicine_shop_search_result_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $medicine_shop_search_result_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
